...
args.add_argument("--checkpoint_dir", type=str, default="/media/scatter/scatterdisk/paraphrase_detection/runs/")

# Model specification
args.add_argument("--model", type=str, default="DeepParaphrase")
...
args.add_argument("--tokenizer", type=str, default="SentencePieceTokenizer")
